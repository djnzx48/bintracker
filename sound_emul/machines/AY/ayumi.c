...
{
    (double)0x0000 / 0xffff, (double)0x0000 / 0xffff,
    (double)0x028f / 0xffff, (double)0x028f / 0xffff,
    (double)0x03b3 / 0xffff, (double)0x03b3 / 0xffff,
    (double)0x0564 / 0xffff, (double)0x0564 / 0xffff,
    (double)0x07dc / 0xffff, (double)0x07dc / 0xffff,
    (double)0x0ba9 / 0xffff, (double)0x0ba9 / 0xffff,
    (double)0x1083 / 0xffff, (double)0x1083 / 0xffff,
    (double)0x1b7c / 0xffff, (double)0x1b7c / 0xffff,
    (double)0x2068 / 0xffff, (double)0x2068 / 0xffff,
    (double)0x347a / 0xffff, (double)0x347a / 0xffff,
    (double)0x4ace / 0xffff, (double)0x4ace / 0xffff,
    (double)0x5f72 / 0xffff, (double)0x5f72 / 0xffff,
    (double)0x7e16 / 0xffff, (double)0x7e16 / 0xffff,
    (double)0xa2a4 / 0xffff, (double)0xa2a4 / 0xffff,
    (double)0xce3a / 0xffff, (double)0xce3a / 0xffff,
    (double)0xffff / 0xffff, (double)0xffff / 0xffff
};

static const double YM_dac_table[] =
{
    (double)0x0000 / 0xffff, (double)0x0000 / 0xffff,
    (double)0x0131 / 0xffff, (double)0x01fa / 0xffff,
    (double)0x02ce / 0xffff, (double)0x0393 / 0xffff,
    (double)0x045a / 0xffff, (double)0x0520 / 0xffff,
    (double)0x063d / 0xffff, (double)0x079a / 0xffff,
    (double)0x08fa / 0xffff, (double)0x0a57 / 0xffff,
    (double)0x0c6d / 0xffff, (double)0x0eef / 0xffff,
    (double)0x116c / 0xffff, (double)0x13e9 / 0xffff,
    (double)0x17af / 0xffff, (double)0x1c70 / 0xffff,
    (double)0x2137 / 0xffff, (double)0x2603 / 0xffff,
    (double)0x2d3a / 0xffff, (double)0x3628 / 0xffff,
    (double)0x3f13 / 0xffff, (double)0x47f6 / 0xffff,
    (double)0x556f / 0xffff, (double)0x6682 / 0xffff,
    (double)0x77a6 / 0xffff, (double)0x88d0 / 0xffff,
    (double)0xa29a / 0xffff, (double)0xc20c / 0xffff,
    (double)0xe142 / 0xffff, (double)0xffff / 0xffff
};
